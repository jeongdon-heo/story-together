...
export default function SameStartEntryPage() {
  ...
  const handleJoin = () => {
    ...
    if (!id) { setError('세션 ID를 입력해 주세요'); return; }
    router.push(`/student/same-start/${id}`);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl p-8 max-w-sm w-full text-center">
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded-xl px-4 py-3 text-center font-mono text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 mb-4"
