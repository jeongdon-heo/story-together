...
4. 3~5문장으로 작성하세요.
5. 학생이 이미 작성한 내용을 반복하지 마세요. 학생의 마지막 문장 이후의 이야기를 바로 이어서 쓰세요.
6. 마지막 문장은 반드시 "~했습니다", "~있었습니다", "~되었습니다" 같은 서술형으로 끝내세요. "~할까요?", "~일까?", "~있을까요?", "과연~?", "~아닐까?" 같은 질문형으로 끝내는 것은 금지입니다. 응답 전체에 물음표(?)를 사용하지 마세요.`;
}
